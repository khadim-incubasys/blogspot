...
$(document).ready(function()
{
	...
	({
		...
		autoSubmit: true,
		vpb_server_url: "do_upload" // PHP file for uploading the browsed files
	});
});
</script>
<style>
...
<center>
  <div style="font-family:Verdana, Geneva, sans-serif; font-size:24px;" align="center">Fancy Multiple File Upload</div>
</center>
<br clear="all" />
