		...
		if(typeof file[file_counter] != undefined && file[file_counter] != '')
		{
			...
			else
			{
				...
				$.ajax({
					...
					beforeSend: function() 
					{
						$("#uploading_"+ids).html('<div align="left"><img src="http://localhost/blogspot/assets/fancy_multiple_file_uploads/images/loadings.gif" width="80" align="absmiddle" title="Upload...."/></div>');
